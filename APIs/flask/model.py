# This Model is orginal from https://github.com/ejcgt/eye-contact-cnn
# We simply modified it so that it can also work on CPU machine.
import torch.nn as nn
import torch
import math


def model_static(pretrained=False, is_gpu=False, **kwargs):
